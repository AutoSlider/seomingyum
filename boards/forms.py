...
class BoardCreateForm(forms.ModelForm):
    class Meta:
        model = Board
        fields = ['input_type', 'input_text', 'input_youtube', 'input_video', ] # 'title', 'note', 'favorite', 'result_text', 'summary_text', 'timeline_text',
        widgets = {
            # base.html
            ...
            # 'result_text': forms.Textarea(attrs={'class': 'form-control'}), # , 'rows': 5
